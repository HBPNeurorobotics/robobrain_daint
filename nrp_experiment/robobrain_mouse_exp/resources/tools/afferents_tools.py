import warnings
warnings.warn("Muscles coefficients in afferents fr estimation is set to 0.. No alternation otherwise")
...
def compute_Ia_fr(stretch,stretchVel,muscActivation,species):
	...
	elif species == "human": return fr_Ia*0.33
...
def compute_II_fr(stretch,muscActivation,species):
	...
	elif species == "human": return fr_II*0.33
	else: raise(Exception("Invalid species"))
